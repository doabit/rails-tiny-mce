module TinyMCE
  ...
  #   unless (instance_methods.include?('draw_with_tinymce'))
  #     class_eval <<-"end_eval", __FILE__, __LINE__  
  #       alias draw_without_tinymce draw
  #       def draw_with_tinymce
  #         draw_without_tinymce do |map|
  #           match "attachments/manage(.:format)" => "attachments#manage"
  #           match "/attachments/create(.:format)" => "/attachments#create"
  #           yield map
  #         end
  #       end
  #       alias draw draw_with_tinymce
  #     end_eval
  #   end
  # end
  # 
